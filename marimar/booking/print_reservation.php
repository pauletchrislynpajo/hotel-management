...
<div id="accom-title"  > 
    ...
    <form action="index.php?view=payment" method="post"  name="" >
           ...
           Greetings from FEU HOTEL!<br/><br/>
          ...
          <tbody>
            ...
            foreach ($cur as $result) {
              ...
              echo '<td> PHP'. $result->PRICE.'</td>';
               echo '<td >1</td>';
                echo '<td >PHP'. $_SESSION['dragonhouse_cart'][$i]['dragonhouseroomprice'].'</td>';
...
If you have any questions, please email at FEU HOTEL or call 09154089248 – 
<br/><br/>
Thank you for choosing FEU HOTEL
<br/><br/>
