...
?>
        ...
        <tr>
          ...
          <td><?php echo  ' PHP'. $result->PRICE; ?></td>
          <td><?php echo   $_SESSION['dragonhouse_cart'][$i]['dragonhouseday']; ?></td>
          <td><?php echo ' PHP'.   $_SESSION['dragonhouse_cart'][$i]['dragonhouseroomprice']; ?></td>
        </tr>
<?php
 ...
 ?> 
    ...
    <div class="right"> 
      <h3 style="text-align: right;">Total: PHP <?php echo   $_SESSION['pay'] ;?></h3>
    </div>
    <br>
    <div class="">
